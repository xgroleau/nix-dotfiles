      ...
      containers = lib.mkMerge [
        {
          ocis = {
            autoStart = true;
            image = "owncloud/ocis:5.0.6@sha256:9b5063c3131297a3e0860d0faecb9407e6077234097ed55a3ec048fa3baca270";
        ...
        (lib.mkIf cfg.collabora.enable {
          ...
          ocis-wopi = {
            autoStart = true;
            image = "cs3org/wopiserver:v10.5.1@sha256:79c33070b1872e767f4acf06cc6a8d9736e482ab9d72309b1565c39567dc08a1";
            extraOptions = [ "--network=ocis-bridge" ];
          ...
          ocis-collabora = {
            autoStart = true;
            image = "collabora/code:24.04.6.1.1@sha256:6fbd1fd525ecd8d3b7f07934c7fbd97388542221bf32a6f30ff15ea881a481ef";
            extraOptions = [
              "--network=ocis-bridge"
              "--cap-add=CAP_MKNOD"
            ];
